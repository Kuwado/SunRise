...
const Landing = () => {
    return (
        <div className={styles.landingPage}>
            ...
            {/* Hero Section */}
            <section className={styles.heroSection} style={{ background: `url(${background.bg1}) no-repeat`, backgroundSize: 'cover' }}>
                {/* Header */}
                <header className={styles.header}>
                    <img src={images.logo} alt="SunRise Logo" className={styles.logo} />
                    <nav className={styles.nav}>
                        <a href='/login'>ログイン</a>
                        <Button curved secondary width='140px'>新規登録</Button>
                    </nav>
                </header>
                <div className={styles.heroContent}>
                    ...
                    <Button curved secondary width='170px' large>すぐ探す</Button>
                </div>
            </section>
            ...
            <section className={styles.bestCoffeeSection}>
                ...
                <div className={styles.rightSection}>
                    <div className={styles.illustration}>
                        <img src={images.cfImage} alt="Coffee and Map Illustration" className={styles.illustrationImage} />
                    </div>
                </div>
            </section>
            ...
            <section className={styles.newStyleSection}>
                ...
                <p className={styles.sectionDescription}>一緒にあらゆるスタイルのカフェを探検しましょう。体験する価値のある新しいカフェが常にあります。</p>
            ...
            <footer className={styles.footer}>
                <div style={{ height: '420px' }}><img src={images.footerTop} alt="Footer Top" className={styles.footerTop} /></div>
                ...
                <div className={styles.footerContent} style={{ background: `var(--bg-secondary) url(${images.footerDown})`, backgroundSize: `contain`}}>
