    ...
    return (
        <div className={cx('container')}>
            <div className={cx('head')}>
                ...
                <Button href={''} primary curved rightIcon={<FontAwesomeIcon icon={faPlus} className={cx('add-btn')}></FontAwesomeIcon>}>追加</Button>
            </div>
            <div className={cx('main')}>
                <div className={cx('filter')}>
                    <div className={cx('title')}>
                    フィルター
                    <span><a href=''><FontAwesomeIcon icon={faRedo}></FontAwesomeIcon>フィルターをクリア</a></span>
                    </div>
                    ...
                    <div className={cx('filter-option')}>
                        <h3>評価</h3>
                        <CheckboxInput id='11'><Rating small rate={1}></Rating></CheckboxInput>
                        <CheckboxInput id='12'><Rating small rate={2}></Rating></CheckboxInput>
                        <CheckboxInput id='13'><Rating small rate={3}></Rating></CheckboxInput>
                        <CheckboxInput id='14'><Rating small rate={4}></Rating></CheckboxInput>
                        <CheckboxInput id='15'><Rating small rate={5}></Rating></CheckboxInput>
                    </div>
                </div>
