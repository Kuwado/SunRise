        ...
        <>
            ...
            <div className={cx('container')}>
                ...
                <div className={cx('head')}>
                    ...
                    <Search placeholder={`名前、料理、場所からレストランを検索`} width={'500px'} value={search} setValue={setSearch} onKeyDown={searchProducts} />
                ...
                <div className={cx('main')}>
                    ...
                    <div className={cx('content')}>
                        <div className={cx('product-list')}>
                            {products.length === 0 ? <div className={cx('no-result')}>No result</div> :
