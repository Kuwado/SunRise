...
const publicRoutes = [
    ...
    { path: config.routes.user.favorite, component: pages.user.favorite, layout: layouts.user.default },
    { path: config.routes.user.map, component: pages.user.map, layout: layouts.user.default },
    { path: config.routes.admin.restaurantList, component: pages.admin.restaurantList, role: 'admin' },
